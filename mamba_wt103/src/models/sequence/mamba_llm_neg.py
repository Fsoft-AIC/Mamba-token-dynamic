    ...
    def __init__(
        ...
        for x_proj in self.backbone.x_proj_list:
            parametrize.register_parametrization(x_proj, "weight",
                                                NegDefiniteMambav2(dt_rank=self.backbone.dt_rank, d_state=16, d_inner=self.backbone.d_inner))
